...
* @{
*/
#define PRODUCT_KEY "f5b1672458644c23a8f423082ccfa0e4"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "bce0c460777a4cb3820224ea287f1d1c"
               
/**@name Device status data reporting interval
* @{
*/
#define REPORT_TIME_MAX 600000 //6S
/**@} */    
...
* @{
*/
#define Heater_BYTEOFFSET                    0
#define Heater_BITOFFSET                     0
#define Heater_LEN                           1
#define Bubble_BYTEOFFSET                    0
#define Bubble_BITOFFSET                     1
#define Bubble_LEN                           1
#define Filter_BYTEOFFSET                    0
#define Filter_BITOFFSET                     2
#define Filter_LEN                           1
#define O3_BYTEOFFSET                    0
#define O3_BITOFFSET                     3
#define O3_LEN                           1
#define Overtime_filter_BYTEOFFSET                    6
#define Overtime_filter_BITOFFSET                     0
#define Overtime_filter_LEN                           1
#define Superheat_BYTEOFFSET                    6
#define Superheat_BITOFFSET                     1
#define Superheat_LEN                           1
#define Undercooling_BYTEOFFSET                    6
#define Undercooling_BITOFFSET                     2
#define Undercooling_LEN                           1

#define Temperature_setup_RATIO                         1
#define Temperature_setup_ADDITION                      20
#define Temperature_setup_MIN                           0
#define Temperature_setup_MAX                           22
#define Timing_RATIO                         1
#define Timing_ADDITION                      0
#define Timing_MIN                           0
#define Timing_MAX                           600
#define Time_filter_RATIO                         1
#define Time_filter_ADDITION                      0
#define Time_filter_MIN                           0
#define Time_filter_MAX                           10200
/**@} */
...
typedef struct {
  ...
  bool valueFilter;
  bool valueO3;
  uint32_t valueTemperature_setup;
  uint32_t valueTiming;
  uint32_t valueTime_filter;
  bool valueOvertime_filter;
  bool valueSuperheat;
  bool valueUndercooling;
} dataPoint_t;
...
typedef struct {
  ...
  uint8_t flagBubble:1;
  uint8_t flagFilter:1;
  uint8_t flagO3:1;
  uint8_t flagTemperature_setup:1;
  uint8_t flagTiming:1;
} attrFlags_t;
...
typedef struct {
  ...
  uint8_t valueTemperature_setup;
  uint16_t valueTiming;
} attrVals_t;
